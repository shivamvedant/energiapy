...
with open(f'/scratch/user/shivam.vedant/Scripts/TSSP/Prelim/ef/corrected/output_64_10_UI_EF.pkl', 'rb') as file:
    load_output_dict = pickle.load(file)
...
with open('demand_dict.pkl', 'wb') as file:
    pickle.dump(demand_dict, file)

with open('norm_demand_dict.pkl', 'wb') as file:
    pickle.dump(norm_demand_dict, file)
...
if __name__ == '__main__':
    ...
    # load_output_dict[design_scen]['Cap_P']['loc5', 'com1_store', 0] = 200
    # load_output_dict[design_scen]['X_P']['loc5', 'com1_store', 0] = 1
    # load_output_dict[design_scen]['Cap_P']['loc5', 'com1_store_discharge', 0] = 200
    # load_output_dict[design_scen]['X_P']['loc5', 'com1_store_discharge', 0] = 1
    # load_output_dict[design_scen]['Cap_S']['loc5', 'com1_store_com1_in_stored', 0] = 100
    # load_output_dict[design_scen]['X_S']['loc5', 'com1_store_com1_in_stored', 0] = 1
    ...
    with open(f'ControlResults_ef_inf_10.pkl', 'wb') as file:
