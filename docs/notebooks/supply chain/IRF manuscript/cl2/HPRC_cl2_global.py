...
if __name__ == '__main__':
    ...
    with open('../cl/ssoln_128_00_cl_global.pkl', 'rb') as file:
    ...
    with open(f"ssoln_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global.pkl", "wb") as file:
    ...
    with open(f'output_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global.pkl', 'wb') as file:
    ...
    with open(f"results_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global.pkl", 'wb') as file:
