...
if __name__ == '__main__':
    ...
    with open(f"ssoln_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global_from_ncl.pkl", "wb") as file:
    ...
    with open(f'output_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global_from_ncl.pkl', 'wb') as file:
    ...
    with open(f"results_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_cl2_global_from_ncl.pkl", 'wb') as file:
