...
if __name__ =='__main__':
    ...
    with open('../cl_step2/ssoln_256_00_Backlog_cl_step2.pkl', 'rb') as file:
    ...
    with open(f"ssoln_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_Backlog_cl_step3.pkl", "wb") as file:
    ...
    with open(f'output_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_Backlog_cl_step3.pkl','wb') as file:
    ...
    with open(f"results_{len(load_scenario_names)}_{int(fill_rate * 10):02d}_Backlog_cl_step3.pkl", 'wb') as file:
