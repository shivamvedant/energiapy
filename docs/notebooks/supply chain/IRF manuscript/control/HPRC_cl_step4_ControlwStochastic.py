...
if __name__ == '__main__':
    ...
    drop_vec = prefix + [1] * (truck_dis_end_idx - truck_dis_start_idx + 1) \
    ...
    fix_design_variables(model2fix=model_final, design_model=load_output_dict[design_scen])
    ...
    with open(f'cl_step4_ControlResults_Backlog.pkl', 'wb') as file:
