...
if __name__ == '__main__':
    ...
    close_loop_results, end_result, end_model, end_scenario = supply_chain_controller(time_ind=scale_iter_list, norm_varying_dict=disruption_dict, p_horizon=30,
    ...
    with open(f'cl_ControlResults_Backlog_ph30_4dual.pkl', 'wb') as file:
