...
def supply_chain_controller(time_ind: List, norm_varying_dict: Dict, start_at: Union[int, Tuple] = 0,
    ...
    for t in range(start_idx, end_idx + 1, 1):
        ...
        if t == 168:
            model.write('model_cl_local_res1.lp', io_options={'symbolic_solver_labels': True})
            # model.write('model_cl_local_res1.mps')
...
if __name__ == '__main__':
    ...
    with open(f'ControlResults_cl_local_res1.pkl', 'wb') as file:
