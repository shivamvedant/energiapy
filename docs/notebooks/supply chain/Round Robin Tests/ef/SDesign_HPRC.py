...
def build_design_model(eps: float, scen_df=pandas.DataFrame()):
    ...
    loc1 = Location(name='loc1',
                    processes={com1_procure, com1_receive_loc2, com1_receive_loc3, com1_process, com1_store,
                               com1_loc1_send}, label="Location 1", scales=scales, demand_scale_level=1,
    ...
    loc5 = Location(name='loc5', processes={com1_receive_loc1, com1_receive_loc2, com1_receive_loc4, com1_receive_loc6,
                    ...
                    label="Location 5", scales=scales, demand_scale_level=1, capacity_scale_level=1,
                    availability_scale_level=1)
    ...
    scenario = Scenario(name=f'design scenario', scales=scales, scheduling_scale_level=1, network_scale_level=0,
...
if __name__ == '__main__':
    ...
    options = {"solver": "gurobi"}
    scenario_creator_kwargs = {'scenario_dict': load_scenario_dict, 'epsilon': fill_rate}
    ...
    exRes_UI = 1 - exPen_UI / (100*200*design_exec_scenarios*design_scale_factor) # daily demand * demand penalty factor
    ...
    final_results_dict = {len(load_scenario_names): {'Expected Cost UI': exCost_UI,
